...
| 📋 **Просмотр паролей** | Таблица с поиском, сортировкой и фильтрацией |
| ✏️ **Редактирование** | Двойной клик по строке |
| 🗑️ **Удаление** | С подтверждением |
| 📤 **Экспорт** | В `.txt`, `.csv`, `.json`, `.docx`, `.pdf` |
| 📥 **Импорт** | Из `.txt`, `.csv`, `.json`, `.docx` |
| 🌓 **Светлая / тёмная тема** | Переключение в главном окне |
