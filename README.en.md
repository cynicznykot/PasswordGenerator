...
![Example Interface](images/screenshot_main.png)

![Example Interface](images/screenshot_save_password.png)
...
- [ ] Build executable files (`.exe`, `.app`) for distribution 
- [ ] Add saved passwords viewer
- [ ] Implement search by service name
- [ ] Add file encryption for saved password
